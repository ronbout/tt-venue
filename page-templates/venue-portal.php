...
function display_new_portal() {
	?>
<div class="col-sm-12 col-md-12 dashboard_grid_cols d-flex justify-content-center align-items-center flex-column"
  id="coming_soon">
  <div class="text-center">
    <h2 class="col-heading d-inline-block">Now Available! <p class="offer">Manage all your offers</p>
    </h2>
...
function display_logout() {
	?>
<a class="nav-link" href="<?php echo wp_logout_url(get_site_url()) ?>" data-toggle="tooltip" data-placement="left"
  title="Logout" id="logout"><i class="fas fa-sign-out-alt"></i></a>
...
function display_old_portal_link($venue_voucher_page) {
    ?>
<li class="nav-item"><a class="nav-link" href="<?php echo get_site_url(null, $venue_voucher_page) ?>">Manage
    Vouchers</a></li>
<?php
}