  ...
  <?php
	...
	**/
	echo "
        ...
        tasteVenue.pboThreshold = ". get_option( 'tf_financials_rounding_threshold', 0.1) . "
			</script>
		";
	$navbar_get = $admin ? "venue-id=$venue_id" : "";
	if (!$venue_id) {
  ...
  <main class="container mb-3">
    ...
    <?php // get the product listing from db 
			...
			$product_rows = $wpdb->get_results($wpdb->prepare("
              ...
              LEFT JOIN $payment_order_xref_table ord_pay ON ord_pay.order_item_id = plook.order_item_id
